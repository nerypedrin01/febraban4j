...
public class CnabGravarTeste {
	public static void main(String[] args) throws IOException, Febraban4jException {
		...
		headerArq.setNumeroInscricao(7622582174L);
		...
		headerArq.setDac(1);
		headerArq.setNomeEmpresa("Calce Perfec");
		...
		segmentoA.setAgenciaContaFav("021554488");
		segmentoA.setNomeFavorecido("Usaflex");
		segmentoA.setNumeroDoc("NF2252");
		segmentoA.setDataDePagamento(Converter.dateToInt(new Date()));
		segmentoA.setMoeda("REA");
		segmentoA.setCodigoISPB("156488");
		...
		segmentoA.setNumeroInscricao(7622582174L);
		...
		headerLote.setInscricaoEmpresa(4856597456L);
		...
		headerLote.setEnderecoEmpresa("Qna27,lote21,sala601");
		headerLote.setNumeroEndereco(1);
		headerLote.setComplemento("PredioVermelho");
		headerLote.setNomeCidade("Brasilia");
		...
		try {
			...
			FileWriter writer = new FileWriter(new File("C:/Users/Pedro/Desktop/modelo.txt"));
			writer.write(text);
			writer.close();
